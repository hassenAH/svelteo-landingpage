...
type SuccessPopupProps = {
    ...
    title?: string;
    message?: string;
    /** Auto-close after ms (set 0 to disable). */
    autoCloseMs?: number;
};
...
export default function SuccessPopup({
    ...
    // Focus the close button when opening (basic focus safety)
    useEffect(() => {
                ...
                <MotionConfig reducedMotion="user">
                    ...
                    >
                        ...
                        <div className={styles.actions}>
                            <button className={styles.primary} onClick={onClose}>Fermer</button>
                        </div>

                        {/* Progress bar (if autoClose enabled) */}
                        {autoCloseMs > 0 && (
                            <motion.div
